...
urlpatterns = [
    ...
    url(r'^api/dj-rest-auth/registration/',
        include('dj_rest_auth.registration.urls')),
    url(r'^api/dj-rest-auth/facebook/',
        user_views.FacebookLoginView.as_view(), name="fb_login"),
    url(r'^api/dj-rest-auth/google/',
        user_views.GoogleLoginView.as_view(), name='google_login'),
